...

{
  ...
  fileSystems."/cuttlefish/audio" =
    {
      device = "systemd-1";
      fsType = "autofs";
    };

  fileSystems."/cuttlefish/documents" =
    {
      device = "systemd-1";
      fsType = "autofs";
    };

  fileSystems."/cuttlefish/games" =
    {
      device = "systemd-1";
      fsType = "autofs";
    };

  fileSystems."/cuttlefish/movies" =
    {
      device = "systemd-1";
      fsType = "autofs";
    };

  fileSystems."/cuttlefish/photos" =
    {
      device = "systemd-1";
      fsType = "autofs";
    };

  fileSystems."/cuttlefish/tv" =
    {
      device = "systemd-1";
      fsType = "autofs";
    };
