...
nix build --option extra-sandbox-paths "/impure/sops-age-keys.txt=/$tmp/sops-age-keys.txt" --option builders "" "path:.#nixosConfigurations.$host.config.system.build.sdImage"
